...
var counter ;
function isLogin(){
    document.querySelector("#logoutdiv").className='hide';
    if(localStorage.userid){
        if(!localStorage.role=='T'){
            location.href='home.html';

        }
        else{
            document.querySelector("#msg").innerText = "Welcome Teacher "+localStorage.userid;
            document.querySelector("#logoutdiv").className='show';
        }
    }
    else{
        location.href='home.html';
